...
from subtitles_filter.lib.ffmpeg import StreamMapper, Probe, Parser

# Configure plugin logger
logger = logging.getLogger("Unmanic.Plugin.subtitles_filter")
...
def on_worker_process(data):
    ...
    if mapper.streams_need_processing():
        ...
        # clear stream mappings, copy all video/audio streams
        ...
        for language in languages:
            ...
            if language and language.lower() :
                mapper.stream_mapping += ['-map', '0:s:m:language:{}?'.format(language)]
